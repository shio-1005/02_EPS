            ...
            switch(Mode)
            {
                case Charge:
                    ...
                    if(cnt >= 10)
                    {
                        ...
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA2, EID8_WRITE, EID0_DATA2);        //HKデータ書き込み        
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA3, EID8_WRITE, EID0_DATA3);                
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA4, EID8_WRITE, EID0_DATA4);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA5, EID8_WRITE, EID0_DATA5);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA6, EID8_WRITE, EID0_DATA6);                
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA7, EID8_WRITE, EID0_DATA7);                
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA8, EID8_WRITE, EID0_DATA8);               
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_2, SIDL_DATA9, EID8_WRITE, EID0_DATA9);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                        
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_2, SIDL_DATA10, EID8_WRITE, EID0_DATA10);               
                        Load_TX_Data(_F_TXB0D0, 8, &HK_1);                                          //データ送信 
                        RTS0(2);
                ...
                case COMM:
                    ...
                    if(cnt >= 10)
                    {
                        ...
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA2, EID8_WRITE, EID0_DATA2);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_2);                                          //データ送信 
                        RTS0(2);
                ...
                case Standby:
                    ...
                    if(cnt >= 10)
                    {
                        ...
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA2, EID8_WRITE, EID0_DATA2);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_3);                                          //データ送信 
                        RTS0(2);
                ...
                case Mission:
                    ...
                    if(cnt >= 10)
                    {
                        ...
                        Write(_TXB0DLC , 0b00001000);                                               //データサイズ8byte
                        Load_TX_ID(_F_TXB0SIDH, SIDH_1, SIDL_DATA2, EID8_WRITE, EID0_DATA2);                 
                        Load_TX_Data(_F_TXB0D0, 8, &HK_4);                                          //データ送信 
                        RTS0(2);
